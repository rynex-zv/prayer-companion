# iOS/iPadOS — Daily prayer table

##input

Widget profile template: Daily prayer table. Target: iOS/iPadOS.
...
BLOCKED: requires a Mac Release build and a real iPhone/iPad WidgetKit installation.
