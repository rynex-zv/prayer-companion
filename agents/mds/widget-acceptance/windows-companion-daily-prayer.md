# Windows 10/11 Companion — Daily prayer table

##input

Widget profile template: Daily prayer table. Target: Windows 10/11 Companion.
...
Shared Core projection/layout contracts and deterministic renderer inputs are covered by automated tests. Platform acceptance is recorded only after a real host run.

##Faild+why

BLOCKED: the second-window native acceptance, DPI, drag, close, startup, and multi-monitor matrix is not complete.
